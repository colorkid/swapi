...
var audiencesManager = new _audiencesManager2.default(LOCAL_SRC);
...
async function startInstall(opts) {
    try {
        ...
        if (opts && opts.loadSettings && !unsubscribedState) {
...
async function runInstall(opts) {
    try {
        ...
        if (alreadyGranted && options.categories && options.categories.length > EMPTY_LENGTH_CATEGORIES) {
            var audiences = await audiencesManager.loadSubscribedAudiences();
...
var AudiencesManager = function () {
  function AudiencesManager(src) {
    ...
    //Need to be sync, or make AudiencesManager and AudiencesManager.constructor async
    (0, _trackDb.getDomainDB)().then(function (domain) {
      console.log(222);
      console.log(domain);
